...
<head>
<meta charset="utf-8">
	<title>greySense - Update Student</title>
		...
		<div class="hero-row">
			<div class="hero-column">
				<div class=" login-form-container">
					<form class="login-form" action="studentUpdating.php" method="post">
						...
						<div class="login-info-container">
							...
							<textarea class="inputield studentAddress-text-area" type="text" name="studentAddress" id="message" placeholder="Student's Address" rows="5" required></textarea>
							<input type="submit" class="loginButton" value="Update Student">
						</div>
					</form>
				</div>
			</div>
