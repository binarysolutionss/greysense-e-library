...
<head>
<meta charset="utf-8">
	<title>greySense - Book Check In</title>
		...
		<div class="hero-row">
			<div class="hero-column">
				<div class=" login-form-container">
					<form class="login-form" action="checkingInProcessing.php" method="post">
						...
						<div class="login-info-container">
							...
							<input type="submit" class="loginButton" value="Check-In">
						</div>
					</form>
				</div>
			</div>
			<div class="hero-comunn hero-column-2">
				<img src="../assets/img/House bookshelves-pana.png" class="hero-vector hero-vector-login">
			</div>
		</div>
	</section>
	<!--End of Hero Section-->
